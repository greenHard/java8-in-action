...
public class Java5NewSpecific {
    public static void main(String[] args) throws InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException, IOException, ClassNotFoundException {
        ...
        System.out.println(autoBoxing.getClass());
        ...
        // double check
        System.out.println(getSingletonInstance() == getSingletonInstance());
        // 1. 反射问题
        System.out.println("========================doubleCheckSerSingletonProblem");
        doubleCheckReflectAttack();
        // 2. 序列化问题
        System.out.println("========================doubleCheckSerSingletonProblem");
        doubleCheckSerSingletonProblem();
        // 枚举的方式
        System.out.println("==========================enumSingletonReflectAttack");
//        enumSingletonReflectAttack();
        System.out.println("==================enumSingletonSerSingletonProblem");
        enumSingletonSerSingletonProblem();

        // 静态导入
        System.out.println("not static import...");
        ...
        System.out.println(checkArgs("must", "1111", ""));
    ...
    private static void enumSingletonReflectAttack() throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
        ...
        System.out.println("正常情况下,没有通过放射攻击的情况: " + (e1 == e2));
        Constructor<EnumSingleton> constructor = EnumSingleton.class.getDeclaredConstructor();
        // 设置之后可以拿到私有方法
        constructor.setAccessible(true);
        EnumSingleton e3 = constructor.newInstance();
        System.out.println("通过反射攻击单例模式情况下，实例化两个实例是否相同：" + (e1 == e3));
    }
    ...
    private static void enumSingletonSerSingletonProblem() throws IOException, ClassNotFoundException {
        ...
        System.out.println("序列化前读取其中的内容：" + es1.getContent());
        ...
        ois.close();
        System.out.println("序列化后读取其中的内容：" + es2.getContent());
        System.out.println("序列化前后两个是否同一个：" + (es1 == es2));
    }
