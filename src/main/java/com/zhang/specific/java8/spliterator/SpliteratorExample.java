package com.zhang.specific.java8.spliterator;
...
/**
 * {@link Spliterator}
 *  可分迭代器,用来遍历数据源中的元素,Java8为集合中所有的数据结构提供了它的实现
 */
    ...
    static class MySpliteratorText {
        ...
        private class MySpliterator implements Spliterator<String> {
            ...
            public int characteristics() {
                /**
                 * IMMUTABLE 数据源不能修改,意味着在遍历的时候不能添加、修改、删除
                 * SIZED 该Spliterator由一个已知大小的源建立(如Set),因此estimateSize 返回的是已知值
                 * SUBSIZED 该Spliterator拆分出来的Spliterator都是SIZED
                 */
